...
async function createDatabase() {
  try {
    await sql`CREATE DATABASE CarrosRapidos;`; 
...
async function create() {
  try {
    ...
    await sql`GRANT ALL PRIVILEGES ON DATABASE CarrosRapidos TO local;`;
    ...
    console.error('Error creating CarrosRapidos or granting privileges:', error.message);
  } finally {
    await sql.end();
  }
}
